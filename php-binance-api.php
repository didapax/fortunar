...
class API
{
    ...
    protected $api_key = 'pcSma9YzuOSVXFX5GMlVDIXazCtRtE4i7vF4YVjisjEtIS9BpL9jzOKbe0scNGsL'; // /< API key that you created in the binance website member area
    protected $api_secret = 'BtSZ0IZ58zC2MIwF9eLfOQsLH3GnS3xcYsN4PRZ9I4c9d3bzBJwLMO0gJCj0HBiv'; // /< API secret that was given to you when you created the api key
